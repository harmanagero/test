...
class CreateAgentAssignmentCommand(BaseModel):
    referenceid: str = Field(description="Reference identifier.")
    isassigned: bool = Field(description="Is agent assignment")
